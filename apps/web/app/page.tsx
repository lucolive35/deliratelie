...
const courses = [
  ...
  },
  {
    id: 2,
    emoji: "🎨",
    title: "Arte Fundamental",
    desc: "Focado na teoria e na pratica dos conceitos basicos da arte, desde luz e sobra, formas, perspectiva e até anatomia.",
    color: VERDE,
    bg: "#F0FFF8",
    price: "R$ 399",
    duration: "1 a 2 dois anos, dependendo do desenvolvimento do aluno",
    tag: "Mais Popular",
  },
  {
    id: 3,
    emoji: "🌀",
    title: "Arte Recreativa",
    desc: "Focado na expressao criativa e no desenvolvimento de habilidades manuais.",
    color: ROSA2,
    bg: "#FFF5F9",
    price: "R$ 399",
